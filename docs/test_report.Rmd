...
```{r expend-plot}
expend_data |>
  ggplot2::ggplot(mapping = ggplot2::aes(reorder(dim2, -mean_thou), mean_thou, fill = dim1))+
  ggplot2::geom_hline(yintercept= seq(0, 400, by = 100), colour = "grey")+
  ggplot2::geom_bar(stat = "identity", position = "stack")+
  ggplot2::labs(
    x = "Expenditure Type",
    y = "Average Expenditure\n (in thousands)"
  )+
  ggplot2::scale_y_continuous(labels = c(0,100,200,300,"$400"))+
