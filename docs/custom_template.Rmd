...
* If `r params$college` does not appear on a visualization, it either did not respond to that question or entered 0.
* A value for `r params$college` in a summary table in 0 indicates either a response of 0 or no response.
...
rank_data |>
  ...
  annotate("segment", 
           ...
           yend = deframe(rank_data[rank_data$dim1 =="Diverse student engagement" & rank_data$`Institution Name` == params$college,'ranking'])+2, 
           colour = "black")+
